				...
				<>
					{publication.links?.twitter && (
						<a
							...
							className="flex flex-row items-center justify-center rounded-full border border-slate-200 p-2 hover:bg-teal-100 dark:border-neutral-800 dark:hover:bg-teal-700 transition"
						>
